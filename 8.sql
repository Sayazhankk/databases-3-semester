...
--departments_pkey,emp_dept_idx,emp_salary_idx,employees_pkey,projects_pkey
--3.1
...
WHERE schemaname = 'public'
ORDER BY tablename, indexname;
--proj_name_hash_idx,dept_name_hash_idx are the largest
--10.2
...
--1 B-tree
--2 used in where,orderr by,group by
--3 if the columns has low selectivity and cardinality
--4 insert:new index entry gets added, updTE:index may be modified , delete:index entries are removed
--5 EXPLAIN ANALYZE your_query;
